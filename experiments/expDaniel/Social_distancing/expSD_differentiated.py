...
if __name__ == "__main__":
    ...
    for i in reduction:
        for j in reduction:
            for k in reduction:
                ...
                social_distancing_work_layer = i
                social_distancing_school_layer = j
                social_distancing_community_layer = k
                hygiene_measures = 0.8
                
                scenario_name = 'social distancing w:'+str(i*100)+' s:'+str(j*100)+' c:'+str(k*100)
    ...
    scens = cv.experiment.run_experiment(expName = 'SDDiffReduction2Steps',scenarios = scenarios, pars=pars)
