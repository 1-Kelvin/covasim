...
if __name__ == "__main__":
    ...
    for i in range(0,4):
        ...
        social_distancing_work_layer = 1-i*factor
        social_distancing_school_layer = 1-i*factor
        social_distancing_community_layer = 1-i*factor
        hygiene_measures = 0.8
        
        scenario_name = 'social distancing '+str(i*factor)+'%'
