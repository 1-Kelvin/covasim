...
def createTestnumScenario(val=[1.5,1.8]):
    ...
    sequence1 = [
        ...
        cv.test_num(200, symp_test=60, sensitivity=sensitivity, quar_test=quar_test, test_delay=test_delay, subtarget={'inds': sim.people.age<target_age, 'vals': val[0]}),
        #cv.test_num(450, symp_test=70, sensitivity=sensitivity, quar_test=quar_test, test_delay=test_delay),
        cv.test_num(900, symp_test=70, sensitivity=sensitivity, quar_test=quar_test, test_delay=test_delay, subtarget={'inds': sim.people.age<target_age, 'vals': val[0]}),
        #cv.test_num(800, symp_test=80, sensitivity=sensitivity, quar_test=quar_test, test_delay=test_delay),
        cv.test_num(1600, symp_test=80, sensitivity=sensitivity, quar_test=quar_test, test_delay=test_delay, subtarget={'inds': sim.people.age<target_age, 'vals': val[0]}), #1
        #cv.test_num(1250, symp_test=90, sensitivity=sensitivity, quar_test=quar_test, test_delay=test_delay),
        cv.test_num(2500, symp_test=90, sensitivity=sensitivity, quar_test=quar_test, test_delay=test_delay, subtarget={'inds': sim.people.age<target_age, 'vals': val[0]}), #1
    ]

    # /w clip edges(40%), subtarget
    sequence2 = [
        #cv.test_num(100, symp_test=60, sensitivity=sensitivity, quar_test=1, test_delay=test_delay),
        cv.test_num(200, symp_test=60, sensitivity=sensitivity, quar_test=1, test_delay=test_delay, subtarget={'inds': sim.people.age<target_age, 'vals': val[0]}),
        #cv.test_num(450, symp_test=70, sensitivity=sensitivity, quar_test=1, test_delay=test_delay),
        cv.test_num(900, symp_test=70, sensitivity=sensitivity, quar_test=1, test_delay=test_delay, subtarget={'inds': sim.people.age<target_age, 'vals': val[0]}),
        #cv.test_num(800, symp_test=80, sensitivity=sensitivity, quar_test=1, test_delay=test_delay),
        cv.test_num(1600, symp_test=80, sensitivity=sensitivity, quar_test=1, test_delay=test_delay, subtarget={'inds': sim.people.age<target_age, 'vals': val[0]}), #1
        #cv.test_num(1250, symp_test=90, sensitivity=sensitivity, quar_test=1, test_delay=test_delay),
        cv.test_num(2500, symp_test=90, sensitivity=sensitivity, quar_test=1, test_delay=test_delay, subtarget={'inds': sim.people.age<target_age, 'vals': val[0]}), #1
    ]
    ...
    #            },
                ...
                'sequence1': {
                'name':'regular testing/clip edges',
                'pars': {
                    'interventions': [
                            cv.sequence(days=[0, 45, 90, 135], interventions=sequence0)
                        ]
                ...
                'pars': {
                    'interventions': [
                            ...
                            cv.sequence(days=[0, 45, 90, 135], interventions=sequence1)
                        ]
                    }
                },
                ...
                'pars': {
                    'interventions': [
                            #cv.sequence(days=[0, 0, 45, 45, 90, 90, 135, 135], interventions=sequence2),
                            cv.sequence(days=[0, 45, 90, 135], interventions=sequence2),
